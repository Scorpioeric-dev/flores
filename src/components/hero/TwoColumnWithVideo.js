...
const Heading = tw.h1`font-black text-red-600 text-3xl md:text-5xl leading-snug max-w-3xl`;
...
const WatchVideoButton = styled.button`
  ...
  .playIcon {
    ${tw`stroke-1 w-12 h-12 text-red-600`}
  }
  .playText {
    ${tw`ml-2 font-medium text-red-600`}
  }
`;
